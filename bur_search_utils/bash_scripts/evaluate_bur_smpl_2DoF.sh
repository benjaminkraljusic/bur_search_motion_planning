...
do
    ...
    do
        ...
        MANIP_LOG_FILE="$(rospack find bur_search_utils)/experiments/results/planar_2DoF/scene000"$problem_number/"manip-"$m_prim_len".csv"
        MANIP_DIST_LOG_FILE="$(rospack find bur_search_utils)/experiments/results/planar_2DoF/scene000"$problem_number/"manip_dist-"$m_prim_len".csv"
